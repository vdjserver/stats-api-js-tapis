...
tapisIO.sendRequest = function(requestSettings, postData) {
        ...
        response.on('end', function() {
            ...
            if (output && jsonApprover.isJSON(output)) {
                ...
                if (tapisSettings.debugConsole === true) {
                    console.error('VDJ-STATS-API ERROR: Tapis response is not json.');
                }
            ...
            if (responseObject && responseObject.status && responseObject.status.toLowerCase() === 'success') {
                ...
                if (tapisSettings.debugConsole === true) {
                    console.error('VDJ-STATS-API ERROR: Tapis returned an error. it is: ' + JSON.stringify(responseObject));
                    console.error('VDJ-STATS-API ERROR: Tapis returned an error. it is: ' + responseObject);
                }
    ...
    request.on('error', function(error) {
        if (tapisSettings.debugConsole === true) {
            console.error('VDJ-STATS-API ERROR: Tapis connection error.' + JSON.stringify(error));
        }
...
tapisIO.sendTokenRequest = function(requestSettings, postData) {
    ...
    var request = require('https').request(requestSettings, function(response) {
        ...
        response.on('end', function() {
            ...
            if (output && jsonApprover.isJSON(output)) {
                ...
                if (tapisSettings.debugConsole === true) {
                    console.error('VDJ-STATS-API ERROR: Tapis token response is not json.');
                }
            ...
            if (
                ...
                if (tapisSettings.debugConsole === true) {
                    console.error('VDJ-STATS-API ERROR: Tapis returned a token error. it is: ' + JSON.stringify(responseObject));
                    console.error('VDJ-STATS-API ERROR: Tapis returned a token error. it is: ' + responseObject);
                }
    ...
    request.on('error', function() {
        ...
        if (tapisSettings.debugConsole === true) {
            console.error('VDJ-STATS-API ERROR: Tapis token connection error.');
        }
